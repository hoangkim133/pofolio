                ...
                <Col>
                    ...
                    >
                        <Row className="section-bt-pro-6">
                            ...
                            <Col xs={11} sm={4} lg={4} md={4} xl={4} xxl={4} >
                            ...
                            <Col>
                                <Row>
                                    <EffectFlyUp delay={0.4}>
                                        ...
                                        <p className="margin-bt-0-mobile">ViCK joint stock company</p>
                                        <p style={{marginBottom: 0}}><b>Location:</b></p>
                                        <p className="margin-bt-0-mobile">Ho Chi Minh, VietNam</p>
                                        <p style={{marginBottom: 0}}><b>Web:</b></p>
                                        <p className="margin-bt-0-mobile"><a href="https://vick.vn/" target="_blank">vick.vn</a></p>
                                    </EffectFlyUp>
                                </Row>
                            </Col>
                        </Row>
                        ...
                        <Row className="section-bt-pro-6">
                            ...
                            <Col>
                                <EffectFlyUp delay={0.2}>
                                    ...
                                    <p className="margin-bt-0-mobile">Java Core, PostgreSQL</p>
                                    <p style={{marginBottom: 0}}><b>Frontend:</b></p>
                                    <p className="margin-bt-0-mobile">Html5, CSS, Vanilla JS</p>
                                    <p style={{marginBottom: 0}}><b>Mobile:</b></p>
                                    <p className="margin-bt-0-mobile">Flutter</p>
                                </EffectFlyUp>
                            </Col>
                        </Row>
                        <Row className="section-bt-pro-6">
                            ...
                            <Col sm={2} lg={2} md={2} xl={2} xxl={2} xs={11}>
                                <EffectFlyUp delay={0.2}>
                                    <p className="margin-bt-0-mobile margin-t-1-mobile"><b>Trading game:</b></p>
